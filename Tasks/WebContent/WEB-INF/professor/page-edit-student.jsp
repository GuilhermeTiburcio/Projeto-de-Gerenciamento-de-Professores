...
<body>
<% Student s = (Student) new StudentController().getElementById(Integer.parseInt(request.getAttribute("cod").toString())); %>
	...
	<br>
	<div class="container">
		<form name="form" action="update-student" method="POST"
			onsubmit="return validate();">
			<input type="hidden" name="id"
							id="id" value=<%out.println(s.getId());%>>
			<div class="row">
				
				<div class="col-sm-4">
					<div class="container">
						<label for="pass">Name</label> <input type="text" name="name"
							id="name" placeholder="Name" class="form-control" value="<%out.println(s.getName());%>">
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="container">
						<label for="pass">RA</label> <input type="text"
							name="ra" id="ra" placeholder="RA" class="form-control" value="<%out.println(s.getRa());%>">
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="container">
						<label for="email">Email address</label> <input type="email"
							...
							aria-describedby="emailHelp" value="<%out.println(s.getLogin());%>">
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="container">
						<label for="pass">Password</label> <input type="Password"
							name="pass" id="pass" placeholder="Password" class="form-control" value="<%out.println(s.getPassword());%>">
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="container">
						<label for="confPass">Confirm your password</label> <input
							...
							placeholder="Confirm your password" class="form-control" value="<%out.println(s.getPassword());%>">
					</div>
				</div>
