...
<body>
	...
	<br>
	<div class="container">
		<h1 class="display-4">Here you can see all tests.</h1>
		<br> <br>
		<div class="row d-flex justify-content-center">
			<form class="form-inline" action="testAdd" method="GET">
		...
		<form onsubmit="return false;">
			<div class="row">
				<div class="col-sm-12">
					<div class="container">
						<label for="emailsearch">Enter the name of the test to
							filter</label> <input type="text" name="emailsearch" id="emailsearch"
							placeholder="Enter the name of the class to filter..."
		...
		<table class="table" id="table">
			<thead>
				<tr>
					...
					<th scope="col"><center>Number of questions</center></th>
			...
			<tbody>
				<c:forEach var="q" items="${list}">
					<tr id="tr">
						...
						<td><center>${q.qntQuestions}</center></td>
						<td><center>
								<a href="professor/page-edit-question.jsp?Cod=${q.id}"><button
										class="btn btn-outline-warning" type="button">Edit</button></a>
							</center></td>
						<td><center>
								<a href="test-delete?Cod=${q.id}"><button
