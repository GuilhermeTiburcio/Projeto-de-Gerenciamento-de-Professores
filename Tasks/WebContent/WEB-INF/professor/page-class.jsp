...
<body>
	...
	<br>
	 <div class="container">
		<h1 class="display-4">Here you can see all classes.</h1>
		<br> <br>
		<div class="row d-flex justify-content-center">
			<form class="form-inline" action="classAdd" method="GET">
		...
		<form onsubmit="return false;">
			<div class="row">
				<div class="col-sm-12">
					<div class="container">
						<label for="emailsearch">Enter the name of the class to filter</label> <input
			...
			<tbody>
				<c:forEach var="q" items="${list}">
					<tr id="tr">
						...
						<td><center>${q.startDate}</center></td>
						<td><center>${q.finalDate}</center></td>
						<td><center>${q.numberStudent}</center></td>
												<td><center>
								<a href="class-update?Cod=${q.id}"><button
										class="btn btn-outline-warning" type="button">Edit</button></a>
							</center></td>
						<td><center>
								<a href="delete-class?Cod=${q.id}"><button
