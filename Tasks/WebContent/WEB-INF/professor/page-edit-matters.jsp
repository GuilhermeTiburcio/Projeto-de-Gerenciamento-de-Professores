...
<body>
	<%
		Matter m = (Matter) new MatterController().getElementById(Integer.parseInt(request.getParameter("Cod")));
	%>
	...
	<div class="container">
		...
		<br> <br> <br> <br>
		<div class="container">
			<form name="form" action="update-matter" method="POST"
					...
					<div class="col-sm-12">
						<div class="container">
							<label for="theme">Name of the matter</label> <input type="text"
								...
								class="form-control" value="<%out.print(m.getName());%>">
								<input type="hidden" id="id" name="id" value="<% out.print(m.getId());%>">
						</div>
					</div>
				</div>
				<br /> <br />
