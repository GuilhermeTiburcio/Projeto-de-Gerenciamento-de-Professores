...
<body>
	...
	<br>
	 <div class="container">
		<h1 class="display-4">Here you can see all matters.</h1>
		<br> <br>
		<div class="row d-flex justify-content-center">
			<form class="form-inline" action="matteradd" method="GET">
				<button type="submit" class="btn btn-outline-info">Add matter!</button>
			</form>
		</div>
		<br> <br>
		...
		<form onsubmit="return false;">
			<div class="row">
				<div class="col-sm-12">
					<div class="container">
						<label for="emailsearch">Enter the name of the matter to filter</label> <input
							type="text" name="emailsearch" id="emailsearch"
							placeholder="Enter the name of the matter to filter..."
		...
		<table class="table" id="table">
			...
			<tbody>
				<c:forEach var="q" items="${AllMatter}">
					<tr id="tr">
						<td><center>${q.name}</center></td>
						
												<td><center>
								<a href="update-matter?Cod=${q.id}"><button
										class="btn btn-outline-warning" type="button">Edit</button></a>
							</center></td>
						<td><center>
								<a href="delete-matter?Cod=${q.id}"><button
